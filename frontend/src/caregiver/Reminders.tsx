...
import { ArrowLeft, Pill, Droplets, Calendar, Activity, Plus, Trash2, ShieldCheck, Users, Check, Power, Volume2 } from 'lucide-react';
    ...
    <div className="min-h-screen relative z-10">
      ...
      <div className="max-w-5xl mx-auto p-6 flex flex-col gap-6">
        ...
        <div className="flex gap-3 border-b border-indigo-500/20 pb-2 overflow-x-auto">
          ...
          <Link to="/caregiver/reminders" className="text-lg font-semibold text-indigo-300 border-b-2 border-indigo-400 pb-2 px-4 whitespace-nowrap">
            Reminders & Schedule
          </Link>
        </div>
